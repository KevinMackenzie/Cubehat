...
#include "../Utilities/Types.hpp"//this will include Rect and Point
...
namespace Quicksand
{
	...
	public:
		...
		class CResourceCache *m_pResCache;
		...
		static void MouseButtonCallbackProc	( GLFWwindow* pWindow, int button, int action, int mods );
		static void CursorPosCallbackProc	( GLFWwindow* pWindow, double x, double y );
		static void CursorEnterCallbackProc	( GLFWwindow* pWindow, int entered );
		static void ScrollCallbackProc		( GLFWwindow* pWindow, double xOffset, double yOffset );
		static void KeyCallbackProc			( GLFWwindow* pWindow, int button, int action, int mods );
		static void CharCallbackProc		( GLFWwindow* pWindow, unsigned int codepoint );
